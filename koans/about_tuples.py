...
class AboutTuples(Koan):
    ...
    def test_tuples_are_immutable_so_item_assignment_is_not_possible(self):
        ...
        self.assertRegexpMatches(msg, "tuple")
    ...
    def test_tuples_of_one_look_peculiar(self):
        self.assertEqual((4).__class__, (1).__class__)
        self.assertEqual((1,2,5).__class__, (1,).__class__)
        self.assertEqual(tuple(["Hello comma!"]), ("Hello comma!", ))

    def test_tuple_constructor_can_be_surprising(self):
        self.assertEqual(tuple("Surprise!"), tuple("Surprise!"))
